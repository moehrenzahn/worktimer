...
enum YAMLCoder {
    ...
    private static func parseDay(_ d: [String: Any]) throws -> WorkDay {
        ...
        guard let rawWork = d["work"] as? [[String: Any]] else {
            throw CoderError.missingWorkKey(dateStr)
        }
